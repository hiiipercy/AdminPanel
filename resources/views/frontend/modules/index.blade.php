...
<div class="col-lg-12">
    <div class="blog-post">
        <div class="blog-thumb">
            <img src="{{ asset('frontend/assets/images/blog-post-01.jpg') }}"
                alt="">
        </div>
...
<div class="col-lg-12">
    <div class="blog-post">
        <div class="blog-thumb">
            <img src="{{ asset('frontend/assets/images/blog-post-02.jpg') }}"
                alt="">
        </div>
        <div class="down-content">
            <span>Healthy</span>
...
<div class="col-lg-12">
    <div class="blog-post">
        <div class="blog-thumb">
            <img src="{{ asset('frontend/assets/images/blog-post-03.jpg') }}"
                alt="">
        </div>
        <div class="down-content">
            <span>Fashion</span>
